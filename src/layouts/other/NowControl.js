...
const NowControl = () => {
  ...
  return (
    ...
    >
      <Button
        style={{ borderRadius: "0", width: "40px", padding: "0" }}
        onClick={() => onScroll("content")}
      >
      ...
      <Button
        style={{ borderRadius: "0", width: "40px", padding: "0" }}
        onClick={() =>
          window.open("http://localhost:4000/tuyen-dung", "_blank")
        }
      >
      ...
      <Button
        ...
        onClick={() =>
          window.open(
            "https://apps.apple.com/us/app/deliverynow/id1137866760",
            "_blank"
          )
        }
      >
